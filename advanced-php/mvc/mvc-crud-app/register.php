...
<input type="password" name="password" class="form-control mb-3" placeholder="Password" data-bvalidator="required,min[3],maxlen[10]">
...
<textarea name="address" class="form-control mb-3" data-bvalidator="required" placeholder="Address"></textarea>
