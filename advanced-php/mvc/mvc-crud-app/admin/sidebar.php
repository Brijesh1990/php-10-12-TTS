<!-- SIDEBAR -->
<div class="sidebar">
<h4 class="text-center mb-4">MyShop Admin</h4>
...
<a href="#" onclick="return confirm('Are you sure to logout as Admin ?')" class="btn btn-sm btn-danger text-white w-50 ms-4 mt-4"><i class="bi bi-power me-2" ></i> Logout</a>
</div>
