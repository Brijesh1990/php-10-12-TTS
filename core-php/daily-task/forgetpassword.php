...
<span class='text-dark p-2'>Your password is : $pass</span>
</div>";
...
<span class='text-dark p-2'>This email does not register please check email</span>
</div>";
header("refresh:3,forgetpassword.php");
}
}
?>
...
<h2 class="mx-auto text-center">Forget Password ?</h2>
<form method="post">
...
<button type="submit" name="frg" class="btn btn-primary">Submit</button>
