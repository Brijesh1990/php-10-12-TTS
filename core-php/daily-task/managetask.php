...
$taskNames=explode(",",$row['approved_task_name']);
...
<div class="task-box mx-auto bg-white p-4">
    <div class="row">
        <div class="col-md-12">
            <h2>Decent task Today  &#128522</h2>
            <h3 class=""><?php echo $_SESSION['name']; ?>!</h3>
           <form method="post">
            <div class="mt-4">
                <!-- give me a google pie chart api -->
                ...
                foreach($taskNames as $taskName){
                    ...
                    <div class="d-flex w-100 justify-content-between mb-3 p-3 border">
                        <h5 class="mb-1"><?php echo $taskName; ?></h5>
                    </div>
                    <?php
                }   
                ?>
              ...
              <a href="content.php" class="btn  rounded-pill float-left fs-5 text-danger"><i class="bi bi-arrow-return-left"></i> Back</a>
